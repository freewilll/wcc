...
void test_param_vreg_moves() {
    ...
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    %dl, %bl");        // arg 2
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    %cl, %r13b");      // arg 3
    ...
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    16(%rbp), %dl");   // arg 6    pushed args get loaded into registers
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    24(%rbp), %cl");   // arg 7
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    32(%rbp), %sil");  // arg 8
    assert_rx86_preg_op_with_function_pc(function->param_count, "movb    40(%rbp), %r9b");  // arg 9

    assert_rx86_preg_op_with_function_pc(function->param_count, "movsbq  %r9b, %r9");       // arg 9    addition code starts here
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %r9, %r9");
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %r9");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %rsi, %rsi");      // arg 8
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rsi");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %rcx, %rcx");      // arg 7
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rcx");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %rdx, %rcx");      // arg 6
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rcx");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %r8, %rcx");       // arg 5
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rcx");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %r14, %rcx");      // arg 4
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rcx");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %r13, %rcx");      // arg 3
    assert_rx86_preg_op_with_function_pc(function->param_count, "addq    %rax, %rcx");
    assert_rx86_preg_op_with_function_pc(function->param_count, "movq    %rbx, %rbx");      // arg 2
