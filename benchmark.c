...
int main(int argc, char **argv) {
    ...
    commands[2] = "./wc42-O1  wc4.c -fuse-registers-for-locals -fno-coalesce-registers --ssa -c -S -o /dev/null";
    commands[3] = "./wc42-ssa wc4.c -fuse-registers-for-locals -fno-coalesce-registers --ssa -c -S -o /dev/null";
