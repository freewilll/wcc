...
int main(int argc, char **argv) {
    ...
    commands[0] = "./wc4           wc4.c --ssa -c -S -o /dev/null";
    commands[1] = "./wc42          wc4.c --ssa -c -S -o /dev/null";
    commands[2] = "./wc42-O1       wc4.c --ssa -c -S -o /dev/null";
    commands[3] = "./wc42-ssa      wc4.c --ssa -c -S -o /dev/null";
    commands[4] = "./wc42-ssa-test wc4.c --ssa -c -S -o /dev/null";
