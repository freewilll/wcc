...
int make_struct_or_union_to_abi_int_registers_move_instructions(Function *function, Tac *ir, Value *arg, int preg_class, int register_index, CallValueLocation *pl, RegisterSet *register_set);
int make_int_struct_or_union_move_from_register_to_stack_instructions( Function *function, Tac *ir, CallValueLocation* pl, int register_index, int stack_index, RegisterSet *register_set, int param_register_vreg);
...
extern int debug_function_return_value_mapping;
