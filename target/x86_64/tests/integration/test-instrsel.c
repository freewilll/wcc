...
void test_instrsel_tree_merging_register_constraint() {
    ...
    finish_ir(function);
    assert_target_op("movq        r1q, r2q");
    assert_target_op("movq        r3q, r1q");
    assert_target_op("addq        r2q, r1q");
    assert_target_op("jmp         .L1"     );
}
...
void test_instrsel_tree_merging() {
    ...
    i(1, IR_EQ,   vsz(4, TYPE_INT), v(1), v(2));
    finish_ir(function);
    assert_target_op("movq        $1, r1q" );
    assert_target_op("movq        $2, r2q" ); nop();
    assert_target_op("cmpq        r2q, r1q");
    assert_target_op("sete        r3b"     );
    assert_target_op("movzbl      r3b, r3l");
    ...
    assert_target_op("movq        r2q, r1q"  );
    assert_target_op("movq        r3q, (r2q)");
    ...
    finish_ir(function);
    assert_target_op("movq        g1(%rip), r1q");
    assert_target_op("movq        g2(%rip), r3q");
    assert_target_op("movq        r3q, g1(%rip)");
    assert_target_op("movq        r1q, g2(%rip)");
}
...
void test_fp_cmp_with_conditional_jmp(Function *function, int cmp_operation, int jmp_operation, char *jmp_instruction) {
    ...
    if (src1_first) {
        assert_target_op("fldt        -16(%rbp)");
        assert_target_op("fldt        -32(%rbp)");
    }
    else {
        assert_target_op("fldt        -32(%rbp)");
        assert_target_op("fldt        -16(%rbp)");
    ...
    assert_target_op("fcomip      %st(1), %st");
    assert_target_op("fstp        %st(0)");
    wasprintf(&template, "%-11s .L1", jmp_instruction);
    assert_target_op(template);
}
...
void test_less_than_with_conditional_jmp(Function *function, Value *src1, Value *src2, int disable_adrq_load, char *template1, char *template2) {
    ...
    src2 = dup_value(src2);
    finish_ir(function);
    assert_target_op(template1);
    assert_target_op(template2);
...
void test_instrsel_expr() {
    ...
    finish_ir(function);
    assert_target_op("movq        r2q, r3q");
    assert_target_op("addq        r1q, r3q");

    // r1 + S1
    start_ir();
    i(0, IR_ADD, v(2), v(1), S(-2));
    finish_ir(function);
    assert_target_op("movq        -8(%rbp), r2q");
    assert_target_op("addq        r1q, r2q");
    ...
    finish_ir(function);
    assert_target_op("movq        g1(%rip), r2q");
    assert_target_op("addq        r1q, r2q");
    ...
    finish_ir(function);
    assert_target_op("movq        $1, g1(%rip)");
    ...
    finish_ir(function);
    assert_target_op("movq        r1q, g1(%rip)");

    // // Store a1 in g using IR_MOVE
    // si(function, 0, IR_MOVE, p(gsz(1, TYPE_CHAR)),  asz(1, TYPE_VOID), 0); assert_target_op("movq        r1q, g1(%rip)");
    // si(function, 0, IR_MOVE, p(gsz(1, TYPE_SHORT)), asz(1, TYPE_VOID), 0); assert_target_op("movq        r1q, g1(%rip)");
    // si(function, 0, IR_MOVE, p(gsz(1, TYPE_INT)),   asz(1, TYPE_VOID), 0); assert_target_op("movq        r1q, g1(%rip)");
    // si(function, 0, IR_MOVE, p(gsz(1, TYPE_LONG)),  asz(1, TYPE_VOID), 0); assert_target_op("movq        r1q, g1(%rip)");
    ...
    finish_ir(function);
    assert_target_op("movq        -8(%rbp), r1q");
    ...
    finish_ir(function);
    assert_target_op("movl        -4(%rbp), r2l");
    assert_target_op("movslq      r2l, r1q");

    // Assign constant to a local
    start_ir();
    i(0, IR_MOVE, S(-2), c(0), 0);
    finish_ir(function);
    assert_target_op("movq        $0, -8(%rbp)");
    ...
    i(1, IR_NOP, 0,    0,    0);
    finish_ir(function);
    assert_target_op("testq       r1q, r1q");
    assert_target_op("jz          .L1");
    ...
    i(1, IR_NOP, 0,    0,    0);
    finish_ir(function);
    assert_target_op("cmpq        $0, g1(%rip)");
    assert_target_op("jz          .L1");
...
void run_function_call_single_arg(Value *src) {
    ...
    tac->src1->return_value_live_ranges = new_set(LIVE_RANGE_PREG_XMM01);
...
void assert_instrsel_types_add_vregs(int dst, int src, char *mov, char *add) {
    ...
    assert_target_op(mov);
    assert_target_op(add);
}
...
void test_instrsel_types_cmp_pointer() {
    ...
    for (j = TYPE_VOID; j <= TYPE_LONG; j++) {
        ...
        i(1, IR_NOP, 0,    0,    0   );
        finish_ir(function);
        assert_target_op("cmpq        $0, r1q");
        assert_target_op("jne         .L1");
...
void test_misc_commutative_operations() {
    ...
    assert_target_op("movq        r2q, r3q");
    assert_target_op("orq         r1q, r3q");

    si(function, 0, IR_BAND, v(3), v(1), v(2));
    assert_target_op("movq        r2q, r3q");
    assert_target_op("andq        r1q, r3q");

    si(function, 0, IR_XOR, v(3), v(1), v(2));
    assert_target_op("movq        r2q, r3q");
    assert_target_op("xorq        r1q, r3q");
}
...
void test_sub_operations() {
    ...
    assert_target_op("movq        r1q, r3q");
    assert_target_op("subq        r2q, r3q");

    si(function, 0, IR_SUB, v(3), c(1), v(2));
    assert_target_op("movq        $1, r2q");
    assert_target_op("subq        r1q, r2q");

    si(function, 0, IR_SUB, v(3), v(1), c(1));
    assert_target_op("movq        r1q, r2q");
    assert_target_op("subq        $1, r2q");

    si(function, 0, IR_SUB, v(3), v(1), g(1));
    assert_target_op("movq        r1q, r2q");
    assert_target_op("subq        g1(%rip), r2q");
    ...
    assert_target_op("movq        $1, r1q");
    assert_target_op("subq        g1(%rip), r1q");

    si(function, 0, IR_SUB, v(3), g(1), c(1));
    assert_target_op("movq        g1(%rip), r1q");
    assert_target_op("subq        $1, r1q");
}
...
void test_bnot_operations() {
    ...
    assert_target_op("movb        r1b, r2b");
    assert_target_op("notb        r2b");

    si(function, 0, IR_BNOT, vsz(3, TYPE_SHORT), vsz(1, TYPE_SHORT), 0);
    assert_target_op("movw        r1w, r2w");
    assert_target_op("notw        r2w");

    si(function, 0, IR_BNOT, vsz(3, TYPE_INT), vsz(1, TYPE_INT), 0);
    assert_target_op("movl        r1l, r2l");
    assert_target_op("notl        r2l");

    si(function, 0, IR_BNOT, v(3), v(1), 0);
    assert_target_op("movq        r1q, r2q");
    assert_target_op("notq        r2q");

    // ~g
    si(function, 0, IR_BNOT, v(3), g(1), 0);
    assert_target_op("movq        g1(%rip), r1q");
    assert_target_op("notq        r1q");
...
void test_constant_operations() {
    ...
    si(function, 0, IR_BNOT, v(1), c(1), 0   ); assert_target_op("movq        $-2, r1q");
    si(function, 0, IR_ADD,  v(1), c(1), c(2)); assert_target_op("movq        $3, r1q" );
    si(function, 0, IR_SUB,  v(1), c(3), c(1)); assert_target_op("movq        $2, r1q" );
    si(function, 0, IR_MUL,  v(1), c(3), c(3)); assert_target_op("movq        $9, r1q" );
    si(function, 0, IR_DIV,  v(1), c(7), c(2)); assert_target_op("movq        $3, r1q" );
    si(function, 0, IR_MOD,  v(1), c(7), c(2)); assert_target_op("movq        $1, r1q" );
    si(function, 0, IR_BAND, v(1), c(3), c(1)); assert_target_op("movq        $1, r1q" );
    si(function, 0, IR_BOR,  v(1), c(1), c(5)); assert_target_op("movq        $5, r1q" );
    si(function, 0, IR_XOR,  v(1), c(6), c(3)); assert_target_op("movq        $5, r1q" );
    si(function, 0, IR_EQ,   v(1), c(1), c(1)); assert_target_op("movq        $1, r1q" );
    si(function, 0, IR_NE,   v(1), c(1), c(1)); assert_target_op("movq        $0, r1q" );
    si(function, 0, IR_LT,   v(1), c(1), c(2)); assert_target_op("movq        $1, r1q" );
    si(function, 0, IR_GT,   v(1), c(1), c(2)); assert_target_op("movq        $0, r1q" );
    si(function, 0, IR_LE,   v(1), c(1), c(2)); assert_target_op("movq        $1, r1q" );
    si(function, 0, IR_GE,   v(1), c(1), c(2)); assert_target_op("movq        $0, r1q" );
    si(function, 0, IR_BSHL, v(1), c(1), c(2)); assert_target_op("movq        $4, r1q" );
    si(function, 0, IR_BSHR, v(1), c(8), c(2)); assert_target_op("movq        $2, r1q" );
...
void test_pointer_load_constant() {
    ...
    for (t = TYPE_CHAR; t <= TYPE_LONG; t++) {
        ...
        assert_target_op("movq        $4294967296, r1q");
    }
}
...
void test_pointer_string_literal() {
    ...
    finish_ir(function);
    assert_target_op("leaq        .LS1(%rip), r2q");
    assert_target_op("movq        r2q, r1q");
    assert_target_op("addq        $1, r1q");
}
...
void test_pointer_indirect_from_stack() {
    ...
    finish_spill_ir(function);
    assert_target_op("movq        -8(%rbp), r3q");
    assert_target_op("movl        (r3q), r2l");
}
...
void test_pointer_indirect_global_char_in_struct_to_long() {
    ...
    finish_ir(function);
    assert_target_op("movq        g1(%rip), r4q");
    assert_target_op("movb        (r4q), r5b");
    assert_target_op("movsbq      r5b, r3q");
}
...
void test_assign_to_pointer_to_void() {
    ...
    si(function, 0, IR_MOVE, asz(2, TYPE_VOID), asz(1, TYPE_CHAR),  0); assert_target_op("movq        r1q, r2q");
    si(function, 0, IR_MOVE, asz(2, TYPE_VOID), asz(1, TYPE_SHORT), 0); assert_target_op("movq        r1q, r2q");
    si(function, 0, IR_MOVE, asz(2, TYPE_VOID), asz(1, TYPE_INT),   0); assert_target_op("movq        r1q, r2q");
    si(function, 0, IR_MOVE, asz(2, TYPE_VOID), asz(1, TYPE_LONG),  0); assert_target_op("movq        r1q, r2q");
}
...
void test_pointer_comparisons() {
    ...
    i(1, IR_NOP,  0,                 0,                    0   );
    finish_ir(function);
    assert_target_op("cmpq        $1, g1(%rip)");
    assert_target_op("jne         .L1");
    ...
    i(1, IR_NOP,  0,                 0,                    0   );
    finish_ir(function);
    assert_target_op("movq        $1, r3q");
    assert_target_op("cmpq        g1(%rip), r3q");
    assert_target_op("jne         .L1");
...
void test_pointer_double_indirect() {
    ...
    for (j = TYPE_VOID; j <= TYPE_LONG; j++) {
        ...
        finish_ir(function);
        assert_target_op("movq        (r1q), r4q");
        assert_target_op("movq        (r4q), r5q");
        assert_target_op("movq        r5q, g4(%rip)");
    }
}
...
void test_composite_pointer_indirect() {
    ...
    test_composite_scaled_pointer_indirect_reg(TYPE_SHORT, 0, TYPE_SHORT, 0, 1); assert_target_op("movw        (r2q,r1q,2), r5w");
    test_composite_scaled_pointer_indirect_reg(TYPE_INT,   0, TYPE_INT,   0, 2); assert_target_op("movl        (r2q,r1q,4), r5l");
    test_composite_scaled_pointer_indirect_reg(TYPE_LONG,  0, TYPE_LONG,  0, 3); assert_target_op("movq        (r2q,r1q,8), r5q");
    test_composite_scaled_pointer_indirect_reg(TYPE_VOID,  1, TYPE_VOID,  1, 3); assert_target_op("movq        (r2q,r1q,8), r5q");

    // Test mov a(b), c instruction
    test_composite_offset_pointer_indirect_reg(TYPE_CHAR,   TYPE_CHAR,   0); assert_target_op("movb        1(r1q), r3b");
    test_composite_offset_pointer_indirect_reg(TYPE_SHORT,  TYPE_SHORT,  0); assert_target_op("movw        1(r1q), r3w");
    test_composite_offset_pointer_indirect_reg(TYPE_INT,    TYPE_INT,    0); assert_target_op("movl        1(r1q), r3l");
    test_composite_offset_pointer_indirect_reg(TYPE_LONG,   TYPE_LONG,   0); assert_target_op("movq        1(r1q), r3q");
    test_composite_offset_pointer_indirect_reg(TYPE_FLOAT,  TYPE_FLOAT,  0); assert_target_op("movss       1(r1q), r3l");
    test_composite_offset_pointer_indirect_reg(TYPE_DOUBLE, TYPE_DOUBLE, 0); assert_target_op("movsd       1(r1q), r3l");
    test_composite_offset_pointer_indirect_reg(TYPE_VOID,   TYPE_CHAR,   1); assert_target_op("movq        1(r1q), r3q");
    test_composite_offset_pointer_indirect_reg(TYPE_VOID,   TYPE_SHORT,  1); assert_target_op("movq        1(r1q), r3q");
    test_composite_offset_pointer_indirect_reg(TYPE_VOID,   TYPE_INT,    1); assert_target_op("movq        1(r1q), r3q");
    test_composite_offset_pointer_indirect_reg(TYPE_VOID,   TYPE_LONG,   1); assert_target_op("movq        1(r1q), r3q");
    test_composite_offset_pointer_indirect_reg(TYPE_VOID,   TYPE_VOID,   1); assert_target_op("movq        1(r1q), r3q");
}
...
void test_composite_pointer_address_of() {
    ...
    test_composite_pointer_address_of_reg(1); assert_target_op("lea         (r2q,r1q,2), r3q");
    test_composite_pointer_address_of_reg(2); assert_target_op("lea         (r2q,r1q,4), r3q");
    test_composite_pointer_address_of_reg(3); assert_target_op("lea         (r2q,r1q,8), r3q");
}
...
void test_constant_cast_to_ptr() {
    ...
    si(function, 0, IR_MOVE, asz(1, TYPE_CHAR),  c(1), 0); assert_target_op("movq        $1, r1q");
    si(function, 0, IR_MOVE, asz(1, TYPE_SHORT), c(1), 0); assert_target_op("movq        $1, r1q");
    si(function, 0, IR_MOVE, asz(1, TYPE_INT),   c(1), 0); assert_target_op("movq        $1, r1q");
    si(function, 0, IR_MOVE, asz(1, TYPE_LONG),  c(1), 0); assert_target_op("movq        $1, r1q");
    si(function, 0, IR_MOVE, asz(1, TYPE_VOID),  c(1), 0); assert_target_op("movq        $1, r1q");
}
...
void test_bitscans() {
    ...
    assert_target_op("bsrl        r1l, r2l");
    assert_target_op("xorl        $0x1f, r2l");
    ...
    assert_target_op("tzcntl      r1l, r2l");
    ...
    assert_target_op("bsrq        r1q, r2q");
    assert_target_op("xorq        $0x3f, r2q");
    ...
    assert_target_op("tzcntq      r1q, r2q");
